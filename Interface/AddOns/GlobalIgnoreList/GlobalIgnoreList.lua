...
local function ApplicationStartup(self)
	...
	filterDefFilter[#filterDefFilter + 1] = "([contains=带] or [contains=接] or [contains=法] or [contains=次] or [contains=趟] or [contains=波] or [contains=拾取] or [contains=托管] or [contains=脱机] or [contains=消费] or [contains=老板] or [contains=有偿]) and ([contains=监狱] or [contains=JY] or [contains=血色] or [contains=墓地] or [contains=教堂] or [contains=玛拉顿] or [contains=MLD] or [contains=祖尔] or [contains=ZUL] or [contains=深渊] or [contains=斯坦] or [contains=STSM] or [contains=后门] or [contains=厄运] or [contains=经验] or [contains=升级] or [contains=效率])"
	filterDefActive[#filterDefActive + 1] = true
