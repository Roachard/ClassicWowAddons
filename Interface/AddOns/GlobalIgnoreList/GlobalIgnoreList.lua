...
local function ApplicationStartup(self)
	...
	filterDefFilter[#filterDefFilter + 1] = "([contains=带] or [contains=接] or [contains=双法] or [contains=三法] or [contains=3法] or [contains=次] or [contains=趟] or [contains=波] or [contains=脱机] or [contains=托管] or [contains=拾取] or [contains=消费] or [contains=有偿]) and ([contains=监狱] or [contains=JY] or [contains=血色] or [contains=墓地] or [contains=教堂] or [contains=祖尔] or [contains=ZUL] or [contains=深渊] or [contains=斯坦] or [contains=STSM] or [contains=后门] or [contains=厄运] or [contains=经验] or [contains=升级] or [contains=效率]) and not [channel=s]"
	filterDefActive[#filterDefActive + 1] = true

	filterDefDesc[#filterDefDesc + 1]     = "飞机"
	filterDefFilter[#filterDefFilter + 1] = "([contains=飞机] or [contains=机票] or [contains=机场] or [contains=航空] or [contains=航班] or [contains=直达] or [contains=直通车] or [contains=快\\ 滴] or [contains=秒拉] or ([contains=G] and ([contains=拉人] or [contains=血'色] or [contains=加基森] or [contains=冬泉谷] or [contains=厄运] or [contains=斯坦] or [contains=STSM]))) and not [channel=s]"
	filterDefActive[#filterDefActive + 1] = true
	...
	filterDefFilter[#filterDefFilter + 1] = "[contains=收] and ([contains=长期] or [contains=无限] or [contains=邮] or [contains=U] or [contains=到付]) and not [channel=s]"
	filterDefActive[#filterDefActive + 1] = true
	...
	filterDefFilter[#filterDefFilter + 1] = "[contains=代工] and not [contains=求] and not [channel=s]"
	filterDefActive[#filterDefActive + 1] = false
	...
	filterDefFilter[#filterDefFilter + 1] = "([contains=血色] or [contains=XS] or [contains=墓地] or [contains=图书馆] or [contains=军械库] or [contains=武器库] or [contains=教堂]) and not ([contains=斯坦] or [contains=STSM] or [contains=区]) and not [channel=s]"
	filterDefActive[#filterDefActive + 1] = false
