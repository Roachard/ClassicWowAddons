...
local function ApplicationStartup(self)
	...
	filterDefFilter[#filterDefFilter + 1] = "([contains=飞机] or [contains=机票] or [contains=航空] or [contains=航班] or [contains=直达] or [contains=直通车] or [contains=秒拉] or ([contains=拉人] and [contains=G])) and not [channel=s]"
	filterDefActive[#filterDefActive + 1] = true
