...
local function ApplicationStartup(self)
	...
	filterDefFilter[#filterDefFilter + 1] = "([name=直达] or [name=直飞] or [name=起飞] or [name=飞船] or [name=起航] or [name=航空] or [name=航线] or [name=列车] or [name=加基] or [name=冬泉] or [name=血色] or [name=东瘟] or [name=斯坦] or [name=索姆]) and not [channel=s]"
	filterDefActive[#filterDefActive + 1] = true

	filterDefDesc[#filterDefDesc + 1]     = "赌博"
	filterDefFilter[#filterDefFilter + 1] = "([contains=骰] or [contains=R] or [contains=猜数] or [contains=银行]) and ([contains=铁] or [contains=暴风]) not [channel=s]"
	filterDefActive[#filterDefActive + 1] = true

	filterDefDesc[#filterDefDesc + 1]     = "金商"
	filterDefFilter[#filterDefFilter + 1] = "([contains=收] or [contains=出] or [contains=卖] or [contains=屯] or [contains=囤] or [contains=手工]) and ([contains=G] or [contains=金] or [contains=米] or [contains=菜] or [contains=粮] or [contains=稻]) and not [channel=s]"
	filterDefActive[#filterDefActive + 1] = true
