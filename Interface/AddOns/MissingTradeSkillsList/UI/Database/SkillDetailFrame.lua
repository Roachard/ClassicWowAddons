...
MTSLDBUI_SKILL_DETAIL_FRAME = {
    ...
    Initialise = function (self, parent_frame)
        ...
        self.ui_frame:SetPoint("BOTTOMLEFT", MTSLDBUI_SKILL_LIST_FRAME.ui_frame, "BOTTOMRIGHT", 0, 0)
        --  Black background
        ...
        self.labels.name.tooltip_frame:SetScript("OnEnter", function() MTSLDBUI_SKILL_DETAIL_FRAME:ToolTipShowSkillName() end)
        ...
        self.labels.type.tooltip_frame:SetScript("OnEnter", function() MTSLDBUI_SKILL_DETAIL_FRAME:ToolTipShowSourceName() end)
        ...
        self.labels.sources.ui_frame:SetScript("OnMouseUp", function() MTSLDBUI_SKILL_DETAIL_FRAME:AddTomTomWayPointPrimarySource() end)
        -- hide on creation
        ...
        self.labels.alt_type.tooltip_frame:SetScript("OnEnter", function() MTSLDBUI_SKILL_DETAIL_FRAME:ToolTipShowAltSourceName() end)
        ...
        -- add on click for tom tom integration
        self.labels.alt_sources.ui_frame:SetScript("OnMouseUp", function() MTSLDBUI_SKILL_DETAIL_FRAME:AddTomTomWayPointSecondarySource() end)
    end,
    ...
    ShowDetailsOfSkill = function(self, prof_name, skill)
        if skill ~= nil then
            ...
            -- Update the Character Screen
            MTSLDBUI_CHARS_SELECTED_SKILL_FRAME:RefreshUI(prof_name, skill.id)
        end
    end,
