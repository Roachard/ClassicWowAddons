...
SpellButton_UpdateButton = function(self)
	...
	local nameColor, subtextColor, iconColor = 41, 42, 43;
	
	-- True: Good Highlight, False: Bad Highlight, Nil: No highlight
	if (inForm == true and colorList[2]) then
		nameColor, subtextColor, iconColor = 21, 22, 23;
	elseif (inForm == false and colorList[3]) then
		nameColor, subtextColor, iconColor = 31, 32, 33;
	elseif (colorList[1]) then
		nameColor, subtextColor, iconColor = 11, 12, 13;
	end
	
	spellString:SetTextColor(colorList[nameColor].r, colorList[nameColor].g, colorList[nameColor].b);
	subSpellString:SetTextColor(colorList[subtextColor].r, colorList[subtextColor].g, colorList[subtextColor].b);
	iconTexture:SetVertexColor(colorList[iconColor].r, colorList[iconColor].g, colorList[iconColor].b);
