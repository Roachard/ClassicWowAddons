...
function TrackOMatic_GetGatherables(profession, skillLevel)
    ...
    local nodes = {
        ...
        [L["HERBALISM"]] = {
            {name = L["HERB_PEACEBLOOM"], skill = 0},       -- see copper
            {name = L["HERB_SILVERLEAF"], skill = 0},       -- ...
            {name = L["HERB_EARTHROOT"], skill = 15},
            {name = L["HERB_MAGEROYAL"], skill = 50},
            {name = L["HERB_BRIARTHORN"], skill = 70},
            {name = L["HERB_STRANGLEKELP"], skill = 85},
            {name = L["HERB_BRUISEWEED"], skill = 100},
            {name = L["HERB_WILD_STEELBLOOM"], skill = 115},
            {name = L["HERB_GRAVE_MOSS"], skill = 120},
            {name = L["HERB_KINGSBLOOD"], skill = 125},
            {name = L["HERB_LIFEROOT"], skill = 150},
            {name = L["HERB_FADELEAF"], skill = 160},
            {name = L["HERB_GOLDTHORN"], skill = 170},
            {name = L["HERB_KHADGARS_WHISKER"], skill = 185},
            {name = L["HERB_WINTERSBITE"], skill = 195},
            {name = L["HERB_FIREBLOOM"], skill = 205},
            {name = L["HERB_PURPLE_LOTUS"], skill = 210},
            {name = L["HERB_ARTHAS_TEARS"], skill = 220},
            {name = L["HERB_SUNGRASS"], skill = 230},
            {name = L["HERB_BLINDWEED"], skill = 235},
            {name = L["HERB_GHOST_MUSHROOM"], skill = 245},
            {name = L["HERB_GROMSBLOOD"], skill = 250},
            {name = L["HERB_GOLDEN_SANSAM"], skill = 260},
            {name = L["HERB_DREAMFOIL"], skill = 270},
            {name = L["HERB_MOUNTAIN_SILVERSAGE"], skill = 280},
            {name = L["HERB_PLAGUEBLOOM"], skill = 285},
            {name = L["HERB_ICECAP"], skill = 290},
            {name = L["HERB_BLACK_LOTUS"], skill = 300},
        },
    };
